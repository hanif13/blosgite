...
class userRegForm(forms.ModelForm):
    ...
    def clean_username(self):
        ...
        if user.exists():
            raise forms.ValidationError("A user with that name already existes")
    ...
    def clean_email(self):
        ...
        if user.exists():
            raise forms.ValidationError("A user with that email already existes")
        ...
        if 'new_password' in self.data and 'confirm_password' in self.data:
            ...
            if new_password != '' and confirm_password != '':
                if new_password != confirm_password:
                    raise forms.ValidationError("Passwords should be matched")
                else:
